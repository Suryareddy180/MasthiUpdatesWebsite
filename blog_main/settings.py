...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-rbaehy#t=_om9(sh%5w+#l!ht5-)n(79=w^u8n=jy75@j3w941')
...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'masthiupdates1.pythonanywhere.com,localhost,127.0.0.1').split(',')
...
AUTHENTICATION_BACKENDS = [
    ...
    'blog_main.backends.EmailBackend',
]
...
MIDDLEWARE = [
    ...
    'blog_main.middleware.SuperuserRedirectMiddleware',  # Custom middleware for superuser redirect
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'suryareddynallimilli@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'vgln wwpr oxjk clcy')
DEFAULT_FROM_EMAIL = 'Masthi Updates <noreply@masthiupdates.com>'
